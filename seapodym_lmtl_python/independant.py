...
def average_temperature_by_fgroup(
    ...
    Output:
    - avg_temperature [time, latitude, longitude, functional_group]
    """
    pass
...
def apply_coefficient_to_primary_production(
    ...
    Output:
    - primary_production [time, latitude, longitude, functional_group]
...
def mask_temperature_by_cohort_by_functional_group(
    ...
    - average_temperature [time, latitude, longitude, functional_group]

    Output:
    - mask_temperature_by_cohort_by_functional_group [time, latitude, longitude, functional_group, cohort_age]
...
def compute_mortality_field(
    ...
    Output:
    - mortality_field [time, latitude, longitude, functional_group]
    """
    pass
