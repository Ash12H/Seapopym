...
class TestConfigurationToDataset:
    ...
    def test_build_fgroup_dataset(self, fgroup_param):
        ...
        assert ConfigurationLabels.lambda_0 in fgroup_dataset
        assert ConfigurationLabels.gamma_lambda in fgroup_dataset
        assert ConfigurationLabels.tr_0 in fgroup_dataset
        assert ConfigurationLabels.gamma_tr in fgroup_dataset
