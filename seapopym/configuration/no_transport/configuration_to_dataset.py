...
def _as_dataset__build_fgroup_dataset(functional_groups: list[FunctionalGroupUnit]) -> xr.Dataset:
    ...
    names_classes = [
        ...
        (FunctionalGroupUnitRelationParameters, ConfigurationLabels.lambda_T_max),
        (FunctionalGroupUnitRelationParameters, ConfigurationLabels.lambda_T_rate),
        (FunctionalGroupUnitRelationParameters, ConfigurationLabels.lambda_pH_max),
        (FunctionalGroupUnitRelationParameters, ConfigurationLabels.lambda_pH_rate),       
