...
def _average_acidity(state: xr.Dataset) -> xr.DataArray:
    """
    ...
    """
    acidity = check_units(state[ForcingLabels.acidity], StandardUnitsLabels.acidity.units)
    ...
    return xr.concat(average_acidity, dim=CoordinatesLabels.functional_group.value)
